...
namespace Garnet
{
    ...
    public class GarnetServer : IDisposable
    {
            ...
            CustomCommandManager customCommandManager)
        {
            ...
            // Fail fast at startup if the AOF page can't hold a migrated range index stream chunk (no-op when
            // the feature or AOF is disabled), rather than surfacing the misconfiguration at the first migration.
